...
class _MyAppState extends State<MyApp> {
  ...
  final subjectText = TextEditingController(text: "ZED Test Meeting");
  final nameText = TextEditingController(text: "ZED Test User");
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('ZED Low-Fi VC App'),
        ),
        body: Container(
